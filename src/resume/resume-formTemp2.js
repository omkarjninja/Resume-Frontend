...
import ResumeTempView from "./resume-tempview";
import ResumeTempView2 from "./resume-tempview2";
function ResumeFormTemp2() {
  ...
  const [degree1, setdegree1] = useState("Bachelors of Enggenering");
  const [degree2, setdegree2] = useState("12Th");
...
export default ResumeFormTemp2;
