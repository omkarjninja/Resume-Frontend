  ...
  return (
    <>
      <div className={`w-full bg-gray-300`}>
            ...
            <div class=" ">
              ...
              <div class="flex items-center justify-between  p-4 sm:p-6">
                <div>
                  ...
                  <p class="text-sm text-gray-600 ">{props.job}</p>
                  <div className="flex">
                    <button
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600 ">
                    Phone:
                    <a className="no-underline" href={`tel:${props.phone}`}>
                      {" "}
                      {props.phone}
                    </a>
                  </p>
                  <p class="text-sm text-gray-600 ">
                    Email:
                    <a className="no-underline" href={`mailto:${props.mail}`}>
                      {" "}
                      {props.mail}
                    </a>
                  </p>
              ...
              <div className=" pl-4 pt-4">
                <h3 class="text-lg font-black  mb-2">Summary</h3>
                <hr class="my-2"></hr>
                <p class="text-sm leading-relaxed text-bold">{props.sum}</p>
              </div>
              {/* experience/projects */}
              <div class="mt-4 pl-4">
                <h3 class="text-lg font-black  mb-2">{props.Heading}</h3>
                <hr class="my-2"></hr>
                <div>
              ...
              {/* education */}
              <div class="mt-4 pl-4">
                <h3 class="text-lg font-black  mb-2">{"Education"}</h3>
                <hr class="my-2"></hr>
                <div>
                  <h4 class="text-md font-semibold ">{props.degree1}</h4>
                ...
                <div class="mt-4">
                  <h4 class="text-md font-semibold  ">{props.degree2}</h4>
                  <p class="text-sm text-gray-600 font-black">
              ...
              {/* skills */}
              <div class="mt-4 pl-4">
                <h3 class="text-lg font-black  mb-2">Skills</h3>
                <hr class="my-2"></hr>
                <ul class="list-disc list-inside text-sm">
                  <li>
              ...
              {/* passion */}
              <div class="mt-4">
                <h3 class="text-lg font-black  mb-2 pl-4">Passion</h3>
                <hr class="my-2"></hr>
                <ul class="list-disc list-inside text-sm">
        ...
        <a
          className="inline-flex items-center gap-2 rounded border border-indigo-600 bg-indigo-600 px-20 ml-10 mb-10 py-3 text-white cursor-pointer   focus:outline-none focus:ring active:text-indigo-500"
