      ...
      <div className={`w-full bg-gray-300`}>
        <div ref={printref} class="container mx-auto py-10 px-5">
          <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class=" ">
              {/* p-4 sm:p-6 */}
              <div class="flex items-center justify-between temp1 p-4 sm:p-6">
                <div>
                  <h2 class="text-2xl font-black  temp-1-head ">
                    {props.name} {props.last}
                  </h2>
                  <p class="text-sm text-gray-600 temp-1-head">{props.job}</p>
                  <div className="flex">
                    <button
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600 temp-1-head">
                    Phone:
                    <a
              ...
              {/* <hr class="my-2 temp-1-head"></hr> */}
              <div className="temp-1-summary pl-4 pt-4">
                <h3 class="text-lg font-black  mb-2 temp-1-name">Summary</h3>
                <hr class="my-2"></hr>
                <p class="text-sm leading-relaxed text-bold">{props.sum}</p>
              </div>
              {/* experience/projects */}
              <div class="mt-4 pl-4">
                <h3 class="text-lg font-black  mb-2 temp-1-name">
                  {props.Heading}
                </h3>
                <hr class="my-2"></hr>
                <div>
              ...
              {/* skills */}
              <div class="mt-4 pl-4">
                <h3 class="text-lg font-black  mb-2 temp-1-name">Skills</h3>
                <hr class="my-2"></hr>
                <ul class="list-disc list-inside text-sm">
                  <li>
              ...
              {/* passion */}
              <div class="mt-4">
                <h3 class="text-lg font-black  mb-2 temp-1-name pl-4">
                  Passion
                </h3>
                <hr class="my-2"></hr>
                <ul class="list-disc list-inside text-sm">
        ...
        <a
          className="inline-flex items-center gap-2 rounded border border-indigo-600 bg-indigo-600 px-20 ml-10 mb-10 py-3 text-white cursor-pointer   focus:outline-none focus:ring active:text-indigo-500 temp-1-download"
